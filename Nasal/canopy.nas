...
var cnpy = aircraft.door.new("canopy", 3);
var switch = props.globals.getNode("sim/model/j22/controls/canopy/canopy-switch", 1);
...
var cockpit_state = func {
	var switch = getprop("sim/model/j22/controls/canopy/canopy-switch");
	if ( switch == 1 ) {
